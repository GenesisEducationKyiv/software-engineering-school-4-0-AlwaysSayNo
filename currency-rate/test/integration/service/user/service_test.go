...
import (
	...
	"github.com/AlwaysSayNo/genesis-currency-api/currency-rate/internal/db/config"
	...
	"github.com/AlwaysSayNo/genesis-currency-api/currency-rate/pkg/util"
	...
	userrepo "github.com/AlwaysSayNo/genesis-currency-api/currency-rate/internal/module/user/repository"
	servuser "github.com/AlwaysSayNo/genesis-currency-api/currency-rate/internal/module/user/service"
...
func (suite *UserServiceSuite) SetupTest() {
	...
	repository := userrepo.NewRepository(suite.tx)
